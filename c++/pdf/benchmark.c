...
pdf_128b_bench(void) {
  ...
  initPDFCrack(&e, NULL, true, NULL, Generative, NULL, charset, 0, 4, true, 0, 0, 0, 0);
  ...
  initPDFCrack(&e, NULL, false, NULL, Generative, NULL, charset, 0, 4, true, 0, 0,0, 0);
  ...
  initPDFCrack(&e,password, false, NULL, Generative, NULL, charset, 0, 4,true,0,0,0, 0);
...
pdf_40b_bench(void) {
  ...
  initPDFCrack(&e, NULL, true, NULL, Generative, NULL, charset, 0, 5, true,0,0,0, 0);
  ...
  initPDFCrack(&e, NULL, false, NULL, Generative, NULL, charset, 0, 5, true,0,0,0, 0);
  ...
  initPDFCrack(&e, password, false, NULL, Generative, NULL, charset,0, 5,true,0,0,0, 0);
